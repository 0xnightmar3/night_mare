...
const features: FeatureItem[] = [
  {
    title: "Real-Time",
    description: "Live status indicators with neon clarity.",
  },
  {
    title: "Glitch Aesthetic",
    description: "Subtle scanlines and glow accents.",
  },
];
...
const ProjectStatusList: FC = () => {
  ...
  return (
    <div className="page status-list-wrapper">
      <AppHero
        title={`NightMare systems`}
        subtitle={`A minimalistic cyberpunk hub for my projects - with uptimes.`}
      />
      <AppFeatures items={features} />
      <h1 className="status-list-title">
        <span className="gradient-yellow">Projects </span>
        <span className="text-small superscript no-break">
          [and their uptime status]
        </span>
      </h1>
